 ...
 */
class CRM_Yhvmigration_Upgrader_Base {

  /**
   * @var CRM_Yhvmigration_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Yhvmigration_Upgrader(
        'biz.jmaconsulting.yhvmigration',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * ```
   * CRM_Yhvmigration_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Yhvmigration_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
